...
void init_data(world_t *world){
    ...
    init_sprite(&world->background, 0, -SCREEN_HEIGHT*(NB_BACKGROUND/2), SCREEN_WIDTH, SCREEN_HEIGHT, BACKGROUND);
...
void update_bullets(world_t *world)
{
        ...
        for(int j = 0; j < world->spaceship.bullets.bullet_nb; j++)
        {
            ...
            world->spaceship.bullets.bullet[j].bullet.y -= 70*world->spaceship.bullets.bullet[j].vy;
